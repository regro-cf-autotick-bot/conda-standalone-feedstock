...
pixi add conda-standalone
# for installing globally
pixi global install conda-standalone
```
...
It is possible to list all of the versions of `conda-standalone` available on your platform:
...
```
pixi search conda-standalone --channel conda-forge
```
